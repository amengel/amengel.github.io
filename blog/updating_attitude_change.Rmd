...
p_wb <- ggplot(subset(wb_means, group == "D.16 D.20 D.24" | group == "R.16 R.20 R.24"), 
  ...
  theme_bw() +
  # facet_wrap(~group, nrow = 9) +
  labs(x = "", y = "", title = "Relative Favorability of White Americans", subtitle = "Difference between white and Black feeling thermometers") +
  scale_color_manual(name = "", values = c("#00AEF3", "#E81B23")) +
  # scale_shape_manual(name = "", values = c(1, 16)) +
  scale_size(guide = F) +
...
[^3]: State and trait could be differentiated as, for instance, feeling anxious versus having an anxious personality. The model asks whether temporary deviations in anxiety, say slightly heightened levels, have future consequences.
